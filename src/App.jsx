import './App.css'
import CansatScene from './components/CansatScene'
import titleCard from './assets/SCORPIUS-Title-detailed-COLORED.svg'
import logoConstellation from './assets/SCORPIUS-Logo-constellation-WHITE.svg'
import starsAsset from './assets/SCORPIUS-Stars-COLORED.svg'
  ...
  return (
    <div className="page">
      ...
      <header className="nav">
        <div className="brand">
          <img src={logoConstellation} alt="Scorpius logo" />
          <span>SCORPIUS</span>
        </div>
      ...
      <main>
        <section className="section hero" id="hero">
          <div className="section-content">
            ...
            <img className="hero-title" src={titleCard} alt="SCORPIUS" />
          ...
          <img className="hero-stars" src={starsAsset} alt="" aria-hidden="true" />
        </section>
